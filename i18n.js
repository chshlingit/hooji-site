...
(function () {
  ...
  var DICT = {
    zh: {
      ...
      s1_h: '押住金幣，說一句話',
      s1_p: '在 iPhone 或 Apple Watch 上押住金幣說話，放開就送出。語音辨識在你的裝置上完成，原始錄音不會離開你的手機。',
      s2_h: 'AI 只看到那一句話',
      ...
      f2_p: '錶面上押住金幣說一句，放開就送出。手錶錄音、iPhone 辨識與記錄，付錢當下五秒內結束。',
      f3_h: 'Siri 不必打開 App',
      ...
      q3: '我的帳目會被上傳嗎？',
      a3: '不會。唯一離開裝置的是你說（或打）的那一句話。金額、商家、分類這些紀錄只存在你的裝置與你自己的 iCloud。',
      q4: '支援哪些裝置？',
      a4: 'iPhone（iOS 17 以上）與 Apple Watch（watchOS 10 以上）。手錶記帳需要搭配 iPhone 上的夥計。',
      q5: '支援哪些語言？',
      a5: '介面提供繁體中文與英文。AI 解析看得懂中文與英文的日常說法，例如「午餐 120」或「lunch 120」。',
      q6: '換手機資料會不見嗎？',
    ...
    en: {
      ...
      hero_b2: 'Speech is recognised on device — no audio uploaded',
      ...
      s1_p: 'Hold the coin on your iPhone or Apple Watch, say one sentence, release to send. Speech is recognised on your device — the recording never leaves your phone.',
      ...
      f2_p: 'Hold the coin on your watch, say it, release. The watch records, your iPhone recognises and logs it — done within seconds of paying.',
      ...
      pri1_h: 'The recording stays on your phone',
      pri1_p: 'Speech recognition happens on your device. Hooji never uploads the audio — only the recognised line of text.',
      ...
      fl1: 'The sentence you said', fl2: 'Relay (stateless, stores nothing)',
      ...
      a3: 'No. The only thing that leaves your device is the sentence you said or typed. Amounts, merchants and categories exist only on your device and in your own iCloud.',
      q4: 'Which devices are supported?',
      a4: 'iPhone (iOS 17 or later) and Apple Watch (watchOS 10 or later). Logging from the watch requires Hooji on your iPhone.',
      q5: 'Which languages are supported?',
      a5: 'The interface is available in English and Traditional Chinese. The AI understands everyday phrasing in both, such as “lunch 120” or 「午餐 120」.',
